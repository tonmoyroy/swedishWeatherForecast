		...
		if(!!navigator.geolocation) {
			...
			navigator.geolocation.getCurrentPosition(function(position) {
			    ...
			    var marker = new google.maps.Marker({
						 ...
						 map: map,
						 title: 'You are here',
						 icon: 'resources/images/maps/you-are-here.png',
						 zIndex: 999999999
					 });
...
var rightControlSet = document.createElement('div');
    ...
    $.getJSON("resources/ajax/smhipoints.json", function(data){
         ...
         $.each(data, function(index, locations){
			...
			/* ===================================================================== */
			 ...
			 iconStandard = 'resources/images/maps/' + locations.propertyType + '-pin.png';
			...
			google.maps.event.addListener(marker, 'mouseover', function() {
				this.setIcon('resources/images/maps/' + locations.propertyType + '-hover-pin.png');
			});
			google.maps.event.addListener(marker, 'mouseout', function() {
				this.setIcon('resources/images/maps/' + locations.propertyType + '-pin.png');
			});
			  ...
			  google.maps.event.addListener(marker, 'click', (function(marker, i) {
					...
					return function() {
						...
						infobox = new InfoBox({
							...
							closeBoxMargin: "0",
							closeBoxURL: "resources/images/maps/close.png",
